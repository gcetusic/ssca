...
var Dajaxice = {
    ...
    other_post: function(callback_function, argv, custom_settings){
        return Dajaxice.call('other_post', 'POST', callback_function, argv, custom_settings);
    },
    ...
    get_args: function(callback_function, argv, custom_settings){
        return Dajaxice.call('app_public.get_args', 'GET', callback_function, argv, custom_settings);
    },

    bye: function(callback_function, argv, custom_settings){
        return Dajaxice.call('app_public.bye', 'GET', callback_function, argv, custom_settings);
    },

    get_public: function(callback_function, argv, custom_settings){
        return Dajaxice.call('app_public.get_public', 'GET', callback_function, argv, custom_settings);
    },

    lol: function(callback_function, argv, custom_settings){
        return Dajaxice.call('app_public.lol', 'POST', callback_function, argv, custom_settings);
    },

    hello: function(callback_function, argv, custom_settings){
        return Dajaxice.call('app_public.hello', 'GET', callback_function, argv, custom_settings);
    }
...
,
    ...
    bye: function(callback_function, argv, custom_settings){
        return Dajaxice.call('more.complex.bye', 'POST', callback_function, argv, custom_settings);
    }
